...
typedef enum
{
  ...
  LSM303_REGISTER_MAG_OUT_Y_H_M             = 0x05, /* Y and Z swapped on compact version */
  LSM303_REGISTER_MAG_OUT_Y_L_M             = 0x06,
  LSM303_REGISTER_MAG_OUT_Z_H_M             = 0x07,
  LSM303_REGISTER_MAG_OUT_Z_L_M             = 0x08,
...
typedef struct lsm303{
  ...
  bool autoRange;
  bool use_accel; // with or with not accelerometer
